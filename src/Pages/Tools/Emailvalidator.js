                                        ...
                                        <div className="columns is-6">
                                            <div className="container">
                                                ...
                                                <div className="flex-column">
                                                    ...
                                                    <input name="txtEmail" onChange={(e) => { setTxtMail(e.target.value) }} value={txtMail} type="text" id="txtEmail" className="input" placeholder="test@gmail.com" />
                                                    <div style={{ margin: '1rem 0px' }}>
                                                        <button onClick={onClickCheckMail} id="btncheck" className="button is-info">Check</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
