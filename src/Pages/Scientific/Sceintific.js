...
export default class Scientific extends Component {
    ...
    handleOnEquals() {
        ...
        this.setState(() => ({
            expression: calculator.getExpression(),
            //expression: calculator.getHistory() && calculator.getHistory()[0].expression,
    ...
    render() {
        return (
            <div style={{ overflowX: 'hidden', flexGrow: 1, height: '89vh' }}>
                <Grid container spacing={3}>
                    <Grid item xs style={{ padding: '0px' }}></Grid>
                    <Grid item xs={12} sm={12} md={6} lg={6}>
                        <Box height='80vh' style={{ position: 'relative' }} >
                            <CssBaseline />
